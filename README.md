...
> 这是一个偏技术/本地运行的 CLI 版本，适合开发者学习和自定义。
>
> 如果你想使用更完整的网页版小红书运营助手，可以访问 **LuNote**：https://lunoteai.com/
>
> LuNote 是面向小红书运营场景的完整产品，提供更友好的网页界面，并围绕选题灵感、爆款笔记分析、内容生成和运营策略辅助做了更多产品化能力。

## 开源版与完整版的关系

这个仓库可以理解为一个简化版的小红书助手 CLI，重点展示核心自动化流程：内容生成、浏览器发布和基础互动。

如果你只是想快速体验或研究实现方式，可以直接使用本项目；如果你更关注日常运营效率、可视化操作、选题灵感和更完整的小红书内容工作流，可以尝试完整版：

👉 **LuNote 小红书运营助手**：https://lunoteai.com/
